...
<div id="wrapper">
	<div class="main-content">
			<div class="col-lg-12 col-xs-12">
				<div class="box-content card white">
					...
					<div class="card-content">
						<form action="aksi-input-kriteria.php" method="post">
							<div class="form-group">
								<label for="exampleInputEmail1">Kriteria</label>
								<input class="form-control" id="nama_kriteria" name='nama_kriteria' placeholder="example Harga">
							</div>
		...
		$query = mysqli_query($koneksi,"SELECT * FROM tabel_master_kriteria ORDER BY nama_kriteria DESC") or die(mysqli_error($koneks));
		...
		echo '<tr><td colspan="3">Tidak ada data!</td></tr>';
			...
			while($data = mysqli_fetch_assoc($query)){	
				echo '<tr>';
					...
					echo '<td><a href="aksi-delete-kriteria.php?id='.$data['id_master_kriteria'].'" onclick="return confirm(\'Yakin?\')">Hapus</a></td>';	
