  ...
  include "../koneksi.php"; 
   ...
   $sql = mysqli_query($koneksi,"select * from tabel_kriteria where id_kriteria='$id_kriteria'");
	...
	<div class="main-content">
		...
		<form method="post" action="aksi-edit-kriteria.php?id=<?php echo $id_kriteria; ?>" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" name="sub" value="<?php echo $data['sub']; ?>" required= "required">
							</div>
								<div class="form-group">
