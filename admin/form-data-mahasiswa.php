	...
	<div class="content">
		...
		<div class="navigation">
			...
			<ul class="menu js__accordion">
				...
				<li>
				<a class="waves-effect" href="form-pilih-agen.html"><i class="menu-icon mdi mdi-cube-outline"></i><span>Pilih Agen</span></a>
				<li>
				<a class="waves-effect" href="form-pendaftaran.html"><i class="menu-icon mdi mdi-desktop-mac"></i><span>Form Pendaftaran</span></a>
				<li>
				<a class="waves-effect" href="form-data-mahasiswa.html"><i class="menu-icon mdi mdi-pencil-box"></i><span>Form Data Mahasiswa</span></a>
...
<div class="fixed-navbar">
	<div class="pull-left">
		...
		<h1 class="page-title">Form Data Mahasiswa</h1>
		<!-- /.page-title -->
	</div>
	<!-- /.pull-left -->
					...
					<div class="card-content">
						<form>
							<div class="form-group">
								...
								<input type="email" class="form-control" id="exampleInputEmail1" placeholder="Id Mahasiswa">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="password" class="form-control" id="exampleInputPassword1" placeholder="Angkatan">
							</div>
