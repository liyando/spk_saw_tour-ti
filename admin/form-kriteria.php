...
<div id="wrapper">
					...
					<div class="card-content">
						<form action="aksi-form-kriteria.php" method="post">
							...
							<div class="form-group">
								...
								<input class="form-control" id="nama_kriteria" name='nama_kriteria' placeholder="">
							</div>
							...
							<div class="form-group">
								...
								<input class="form-control" id="kriteria" name='kriteria' placeholder="">
							</div>
	...
	<a href="aksi-delete-data-form-kriteria.php?id=<?php echo $r['id_kriteria'];?>" onclick="return confirm(\'Yakin?\')">Hapus</a></td>
